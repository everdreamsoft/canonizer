...
class BalanceEntity extends Entity_1.Entity {
    constructor(balanceFactory, balanceData) {
        super(balanceFactory, [new Reference_1.Reference(balanceFactory.sandraManager.get(BalanceFactory_1.BalanceFactory.BALANCE_ITEM_ID), BalanceEntity.getBalanceUniqueId(balanceData.contract))]);
