...
export class BlockchainTransfer extends BlockchainEvent {
    ...
    public constructor(factory: BlockchainEventFactory | null,
        ...
        //create the block
        let blockchainBlock = new BlockchainBlock(blockchain.blockFactory, blockId, timestamp, blockchain, sandra);
