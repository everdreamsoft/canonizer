...
class JetskiEntity extends Entity_js_1.Entity {
    constructor(factory, sandra, name) {
        super(factory, [new Reference_1.Reference(sandra.get(JetskiEntityFactory_js_1.JetskiEntityFactory.JETSKI_INSTANCE), JetskiEntityFactory_js_1.JetskiEntityFactory.LATEST_JETSKI + name)]);
    }
