...
class EthereumBlockchain extends Blockchain_js_1.Blockchain {
    constructor(sandra) {
        ...
        this.blockFactory = new EntityFactory_1.EntityFactory(this.getName() + "Block", "blockchainBlocFile", sandra, sandra.get(BlockchainBlock_1.BlockchainBlock.INDEX_SHORTNAME));
    }
}
