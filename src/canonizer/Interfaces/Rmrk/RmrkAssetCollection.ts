...
export class RmrkAssetCollection extends AssetCollection{
    ...
    public constructor(factory: AssetCollectionFactory, collectionInterface:AssetCollectionInterface, sandra: SandraManager,maxSupply:Number) {
    ...
    public static createRmrkCollection(canonizeManager:CSCanonizeManager,collectionInterface:AssetCollectionInterface,maxSupply:Number){

        return new RmrkAssetCollection(canonizeManager.getAssetCollectionFactory(), collectionInterface, canonizeManager.getSandra(), maxSupply) ;
    }
