...
class BlockchainContract extends Entity_js_1.Entity {
    constructor(factory, id, sandraManager, standard = null) {
        ...
        super(factory, [new Reference_js_1.Reference(sandraManager.get(BlockchainContractFactory_js_1.BlockchainContractFactory.ID), id)]);
        if (standard) {
            this.joinEntity(BlockchainContractFactory_js_1.BlockchainContractFactory.CONTRACT_STANDARD, standard, sandraManager);
        }
    }
